...
tk.Label(root, textvariable=bmi_value).grid(row=3, column=0, columnspan=2)
tk.Label(root, textvariable=bmi_category).grid(row=4, column=0, columnspan=2)
